...
namespace VMM {
    ...
    extern uint32_t *globalPD;

    extern void delete_page(uint32_t virtualPageNumber, uint32_t *pageDirectory);

    extern void map_page(uint32_t virtualPageNumber, uint32_t physicalPageNumber, uint32_t *pageDirectory);
